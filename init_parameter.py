...
def init_model():
    ...
    parser.add_argument("--bert_model", default="/workspace/model/bert-base-uncased", type=str,
                        help="The path or name for the pre-trained bert model.")

    parser.add_argument("--tokenizer", default="/workspace/model/bert-base-uncased", type=str,
